...
import com.mycompany.myapp.service.JhipsterGatewayKafkaConsumer;
...
public class JhipsterGatewayKafkaResourceIT {
    ...
    @Autowired
    private JhipsterGatewayKafkaProducer producer;

    @Autowired
    private JhipsterGatewayKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterGatewayKafkaResource kafkaResource = new JhipsterGatewayKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-gateway-kafka/publish?message=test"))
